...
from utils.kfac_ops.controller.weight_container import *
...
class WeightController(object):
    def __init__(self, data_size, particles, fisher_approx='kron', kl=1., eta=1.):
        ...
        self._variation_type = fisher_approx

        # Set up the hyper-parameters.
        self._coeff = kl / float(self._data_size)
        self._eta = eta
    ...
    def change_particles(self, new_particles):
        self._particles = new_particles

    def register_conv_layer(self, kernel_size, in_channel, out_channel, eta=1.):
    ...
    def register_fc_layer(self, input_size, output_size, eta=1.):
